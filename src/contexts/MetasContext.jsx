...
export function MetasProvider({ children }) {
    const [metas, setMetas] = useState(() => {
        ...
        if (!stored) return [
            ...
            { id: 2, titulo: 'Correr 5km sem parar', area: 'Saúde', prazo: '15/04/2025', descricao: 'Treinar 3x por semana até conseguir completar 5km contínuos.', progresso: 65 },
            ...
            { id: 4, titulo: 'Ligar para a família toda semana', area: 'Relacionamentos', prazo: '31/03/2025', descricao: 'Manter contato semanal com pais e irmãos.', progresso: 80 },
        ]
        try {
