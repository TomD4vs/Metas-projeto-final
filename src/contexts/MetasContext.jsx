...
export function MetasProvider({ children }) {
    const [metas, setMetas] = useState(() => {
        ...
        if (!stored) return [
            { id: 1, titulo: 'Certificação AWS', area: 'Carreira', prazo: '30/03/2026', descricao: 'Estudar e passar no exame Solutions Architect Associate.', progresso: 40 },
            ...
            { id: 3, titulo: 'Reserva de emergência', area: 'Finanças', prazo: '31/12/2026', descricao: 'Juntar 6 meses de despesas fixas na poupança.', progresso: 20 },
